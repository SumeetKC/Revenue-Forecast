...
<body>
	<div align="center">
		<form method="post" action="up_pls.html" enctype="multipart/form-data">
		<div align="right">
				<a id="export" href="downloadtemplate.html?name=projectlist">Download
					Template</a>
			</div>
			<table cellpadding="8px">
				<tr>
					...
					<td><input style="font-size: 15px;" type="file"
						name="Project_List_file" id="Project_List_file" required="required" /></td>
				</tr>
			</table>
		<br/>
