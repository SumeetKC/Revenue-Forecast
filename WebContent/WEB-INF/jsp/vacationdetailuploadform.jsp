...
<body>
	<div align="center">
		<form method="post" action="up_vds.html" enctype="multipart/form-data">
		<div align="right">
				<a id="export" href="downloadtemplate.html?name=vacationdetails">Download
					Template</a>
			</div>
			<table cellpadding="8px">
				<tr>
					...
					<td><input style="font-size: 15px;" type="file"
						name="Vacation_Details_file" id="Vacation_Details_file" required="required" /></td>
				</tr>
			</table>
