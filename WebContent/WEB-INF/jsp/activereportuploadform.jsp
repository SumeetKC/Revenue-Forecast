...
<body>
	<div align="center">
		<form method="post" action="up_ar.html" enctype="multipart/form-data"
			id="allocatioupload">
			<div align="right">
				<a id="export" href="downloadtemplate.html?name=allocation">Download
					Template</a>
			</div>
			<table cellpadding="8">
				<tr>
					...
					<td><input style="font-size: 15px;" type="file"
						name="allcoationReportFile" id="allcoationReportFile"
						required="required" /></td>
				</tr>
			</table>
			<br /> <input style="font-size: 15px; padding: 6px 24px;"
				type="submit" value="Save" onclick="cnfrm()" />
		</form>
	</div>
